...
<nav class="flex text-sm text-gray-500 mb-4 pl-10" aria-label="Breadcrumb">
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        <li class="inline-flex items-center">
            <a href="{{ $dashboardUrl }}" class="inline-flex items-center text-gray-500 hover:text-blue-600">
            ...
            @foreach ($breadcrumbs as $breadcrumb)
                <li>
                    <div class="flex items-center">
                        ...
                        @else
                            <span class="text-blue-600 font-semibold">{{ $breadcrumb['label'] }}</span>
                        @endif
                    </div>
                </li>
            @endforeach
