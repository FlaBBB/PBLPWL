            ...
            <div class="flex flex-col gap-2">
                <nav class="flex flex-col gap-2 mt-10">
                    ...
                    <a href="{{ route('dosen.mahasiswa-bimbingan') }}"
                        class="flex text-sm font-semibold items-center gap-3 pl-10 py-2 {{ ($activeMenu == 'mahasiswa-bimbingan') ? 'text-[#1E6AAE] font-medium hover:bg-blue-50 transition border-r-[#1E6AAE] border-r-3' : 'text-[#7C8DB5] font-medium text-sm hover:bg-blue-50 transition' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
>>>>>>> 0986e7bf87a867819350b0d66c3c6f9d1266deb4
            </div>
        </div>
    </aside>
</div>