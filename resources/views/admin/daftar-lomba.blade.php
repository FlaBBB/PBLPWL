                ...
                <tbody>
                    @forelse($competition as $item)
                        <tr class="border-b border-gray-200 hover:bg-gray-50">
                            <td class="px-4 py-2">{{ $loop->iteration + ($competition->currentPage() - 1) * $competition->perPage() }}</td>
                            <td class="px-2 py-2">{{ $item->name }}</td>
                            <td class="px-2 py-2">{{ $item->organizer }}</td>
                            <td class="px-2 py-2 text-left">{{ ucfirst(strtolower($item->level->value)) }}</td>
                            <td class="px-2 py-2">
...
<script>
    let currentLombaId = null; // To store the ID of the lomba being detailed
