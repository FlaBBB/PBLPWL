    ...
    <div class="grid grid-cols-3 gap-6 mb-8">
        <div class="col-span-2 bg-white rounded-xl shadow p-6">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full text-left text-sm border-separate border-spacing-y-2">
                    <thead>
                        <tr class="text-gray-500 bg-gray-100">
                            <th class="py-3 px-4 font-semibold">No</th>
                            <th class="py-3 px-4 font-semibold">Nama Lomba</th>
                            <th class="py-3 px-4 font-semibold">Penyelenggara</th>
                            <th class="py-3 px-4 font-semibold">Batas Pendaftaran</th>
                    ...
                    <tbody>
                        <tr class="odd:bg-gray-50 even:bg-white hover:bg-blue-50 transition">
                            ...
                            <td class="py-3 px-4">GEMASTIK</td>
                            <td class="py-3 px-4">Puspresnas</td>
                            <td class="py-3 px-4">25 Agustus 2021</td>
                            <td class="py-3 px-4">
                                <a href="#" class="inline-flex items-center text-center px-3 py-1 border border-blue-600 text-blue-600 rounded hover:bg-blue-600 hover:text-white text-xs transition">Lihat detail</a>
                            </td>
                        </tr>
                        <tr class="odd:bg-gray-50 even:bg-white hover:bg-blue-50 transition">
                            <td class="py-3 px-4">2</td>
                            <td class="py-3 px-4">Hackathon Merdeka</td>
                            <td class="py-3 px-4">Institut Merdeka</td>
                            <td class="py-3 px-4">11 Januari 2022</td>
                            <td class="py-3 px-4">
                                <a href="#" class="inline-flex items-center text-center px-3 py-1 border border-blue-600 text-blue-600 rounded hover:bg-blue-600 hover:text-white text-xs transition">Lihat detail</a>
                            </td>
                        </tr>
                        <tr class="odd:bg-gray-50 even:bg-white hover:bg-blue-50 transition">
                            ...
                            <td class="py-3 px-4">IoT Competition</td>
                            <td class="py-3 px-4">Kementerian Pendidikan</td>
                            <td class="py-3 px-4">21 Desember 2021</td>
                            <td class="py-3 px-4">
                                <a href="#" class="inline-flex items-center text-center px-3 py-1 border border-blue-600 text-blue-600 rounded hover:bg-blue-600 hover:text-white text-xs transition">Lihat detail</a>
                            </td>
                        </tr>
