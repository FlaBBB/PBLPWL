                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-50">
                            ...
                            <td class="px-6 py-2">
                                <div class="flex space-x-2">
                                    <button onclick="openDetailModal({{ $achievement->id }})" class="border border-[#1e6aae] text-[#1e6aae] hover:bg-[#1e6aae] hover:text-white  px-2 py-2 rounded text-xs flex items-center gap-1" title="Lihat Detail">
