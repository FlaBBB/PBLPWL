...
@section('content')
    <main class="flex-1 px-10">
        <div class="w-200 mx-auto p-6 border border-gray-300 rounded-lg ">
            ...
            <div class="flex flex-col space-y-2 space-x-6 py-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col space-y-1">
                        <label for="ttl" class="block text-sm font-medium text-gray-500">Tanggal Lahir</label>
                    ...
                    <div class="flex flex-col space-y-1">
                        <label for="telepon" class="block text-sm font-medium text-gray-500">Alamat</label>
                        <input type="text" id="telepon" name="telepon"
                            class="text-sm block w-full border border-gray-300 rounded-lg px-2 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                            value="+62 812-3456-7890">
                    </div>
            ...
            <div class="flex flex-col space-y-2 space-x-6 py-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div class="flex flex-col space-y-1">
                        <label for="nama" class="block text-sm font-medium text-gray-500">NIDN</label>
                        <input type="text" id="nama" name="nama"
                            class="text-sm block w-full border border-gray-300 rounded-lg px-2 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                            value="2341720122">
                    </div>
            ...
            <div class="flex flex-col space-y-2 space-x-6 py-6 mb-4">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div class="flex flex-col space-y-1 relative">
                        <label for="minat" class="block text-sm font-medium text-gray-500">Minat dan Keahlian</label>
                        {{-- Dropdown Trigger --}}
            ...
            <div class="flex justify-end">
                <button type="submit"
                    class="bg-[#1E6AAE] text-white py-2 px-6 rounded-sm hover:bg-[#17497C] transition duration-200">
                    Simpan
                </button>
            </div>
