...
@section('content')
    <main class="flex-1 px-6 pb-12">
        <div class="w-full mx-auto p-6 border border-gray-200 rounded-lg">
            ...
            <div class="max-w-max mx-auto mt-8 px-4 grid grid-cols-[1fr_2fr] gap-4">
                <!-- Poster -->
                <div class="">
                    <img src="https://placehold.co/100x120?text=Poster+goes+here.&font=poppins" alt="Banner Event"
                                class="w-full rounded-lg h-full object-cover object-top">
                </div>
                ...
                <div class="ml-6 space-y-4">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <span class="text-sm text-[#1e6aae] px-2 py-1 border border-[#1e6aae] rounded-md font-medium">Cyber
                            Security</span>
                        <span
                            class="text-sm text-[#1e6aae] px-2 py-1 border border-[#1e6aae] rounded-md font-medium">Internet
                            of Thing (IoT)</span>
                    </div>
